...
<a href="" title="GitHub"  target="_blank">
    ...
    <path class="st0" d="M10,0.2c-5.5,0-10,4.5-10,10c0,4.4,2.9,8.2,6.8,9.5c0.5,0.1,0.7-0.2,0.7-0.5c0-0.2,0-0.9,0-1.7
    ...
    \tC20,4.7,15.5,0.2,10,0.2"/>
    </svg>
</a>
       
<a href="https://stackoverflow.com/questions/tagged/lestajs" title="Stack Overflow" target="_blank">
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="m18.986 21.865v-6.404h2.134v8.539h-19.276v-8.539h2.13v6.404zm-12.875-2.134h10.739v-2.137h-10.739zm.259-4.852 10.48 2.189.451-2.07-10.478-2.187zm1.359-5.056 9.705 4.53.903-1.95-9.706-4.53-.902 1.936zm2.715-4.785 8.217 6.855 1.359-1.62-8.216-6.853-1.35 1.617zm5.307-5.038-1.746 1.294 6.405 8.604 1.746-1.294-6.407-8.604z"/></svg>
</a>
<a href="https://www.youtube.com/@lestajs" title="YouTube" target="_blank">
      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="256" height="256" viewBox="0 0 256 256" xml:space="preserve">
      <g style="stroke: none; stroke-width: 0; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: #202020; fill-rule: nonzero; opacity: 1;" transform="translate(1.4065934065934016 1.4065934065934016) scale(2.81 2.81)" >
      <path d="M 88.119 23.338 c -1.035 -3.872 -4.085 -6.922 -7.957 -7.957 C 73.144 13.5 45 13.5 45 13.5 s -28.144 0 -35.162 1.881 c -3.872 1.035 -6.922 4.085 -7.957 7.957 C 0 30.356 0 45 0 45 s 0 14.644 1.881 21.662 c 1.035 3.872 4.085 6.922 7.957 7.957 C 16.856 76.5 45 76.5 45 76.5 s 28.144 0 35.162 -1.881 c 3.872 -1.035 6.922 -4.085 7.957 -7.957 C 90 59.644 90 45 90 45 S 90 30.356 88.119 23.338 z" style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: #202020; fill-rule: nonzero; opacity: 1;" transform=" matrix(1 0 0 1 0 0) " stroke-linecap="round" />
...
<!--          </svg>-->
<!--</a>-->
<a href="https://t.me/lestajs_ru" title="Telegram" target="_blank">
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        \t viewBox="0 0 20 20" style="enable-background:new 0 0 20 20;" xml:space="preserve">
        
        \t\t\t<path d="M19.3,2.7c0,0.1,0,0.5,0,0.7c-0.3,2.8-1.4,9.6-2,12.8C17,17.5,16.5,18,16.1,18c-0.8,0.1-1.5-0.4-2.2-0.9
        \t\t\t\tc-0.2-0.1-0.4-0.3-0.6-0.4c-0.8-0.5-1.5-1-2.1-1.4c-0.6-0.4-1.2-0.8-1.9-1.3c-1.5-1-0.9-1.6,0-2.4c0.1-0.1,0.3-0.3,0.4-0.4
        \t\t\t\tc0.1-0.1,0.4-0.3,0.8-0.7c1.4-1.3,4-3.7,4.1-4c0,0,0-0.2-0.1-0.3C14.4,6,14.2,6,14.1,6c-0.2,0-2.7,1.7-7.5,4.9
        \t\t\t\tc-0.7,0.5-1.3,0.7-1.9,0.7c-0.6,0-1.9-0.4-2.8-0.7c-0.1,0-0.3-0.1-0.4-0.1C0.6,10.6-0.1,10.4,0,9.9c0-0.3,0.5-0.6,1.3-1
        \t\t\t\tC6.5,6.6,10,5.1,11.7,4.4c4.9-2,6-2.4,6.6-2.4c0.1,0,0.5,0,0.7,0.2C19.2,2.4,19.2,2.5,19.3,2.7z"/>
